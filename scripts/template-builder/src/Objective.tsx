export const Objective = (): any => {
    return <div className="py-5">
        ...
        <p>A motivated developer, currently working as a team lead, dedicated continuously on developing, designing,
            ...
            supporting and experimenting new technologies and adopting best practices, offers himself as candidate to
            solve and produce effective and innovative applications.</p>
    </div>
}