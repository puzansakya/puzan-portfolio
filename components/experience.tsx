    ...
    const experiences = [
        {
            ...
            position: "Senior Software Engineer | Tech Lead - Frontend",
            from: "2021-06-21",
            to: "",
        ...
        },
        {
            ...
            from: "2020-12-20",
            to: "2022-02-01",
            description: "Worked as full stack developer. Developed and maintained a claim portal application to manage insurance claims for us based consumer gorups, Includes technology stack like angular js, java, spring boot, mysql, selenium, queryDSL, JPA and hibernate"
        },
        {
            ...
            <ol className="relative border-s border-gray-200 dark:border-gray-500">
                {experiences.map((e: any, index: number) => {
                    return <li key={index} className="mb-10 ms-4">
                        ...
                        <div className="">
                            <h3 className="inline-block text-lg font-semibold text-gray-900 dark:text-white">{e.company}</h3>
                            &nbsp;
                            &nbsp;
                            <p className="inline-block text-sm text-gray-900 dark:text-gray-100">({e.position})</p>
                        </div>
